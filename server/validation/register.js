...
const validateRegisterInput = data => {
  ...
  if (!Validator.isLength(data.password, { min: 7, max: 30 })) errors.password = 'Password must be at least 7 characters';
  if (Validator.isEmpty(data.password2)) errors.password2 = 'Please confirm Password';
